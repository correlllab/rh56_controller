...
SMOKE_COMMANDS = [
    ...
    [
        ...
        "4",
        "--out",
        "artifacts/analytical_grasp_volume_smoke",
    ],
    [
        sys.executable,
        ...
        "100",
        "--out",
        "artifacts/hybrid_margin_sweep_smoke",
    ],
    [
        sys.executable,
        "tools/replay_force_thresholds.py",
        "--out",
        "artifacts/threshold_replay_smoke",
    ],
]
...
FULL_COMMANDS = [
    ...
    "python tools/run_analytical_grasp_volume.py --objects ycb_cracker_box ycb_sugar_box ycb_potted_meat_can --grid-step-mm 30 --yaw-samples 16 --out artifacts/analytical_grasp_volume/",
